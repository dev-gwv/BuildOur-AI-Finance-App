...
export function EmailTemplateForm({
  ...
  return (
    <form onSubmit={save} className="grid gap-4">
      ...
      <Field label="Message" hint="Sent above the invoice summary. It can still be tweaked for one particular email when sending.">
        <Textarea value={bodyValue} onChange={(e) => setBodyValue(e.target.value)} rows={12} className="leading-relaxed" />
      </Field>
